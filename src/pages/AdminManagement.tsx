...
const AdminManagement = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Управление правами</h1>
        <p className="text-gray-600 mt-2">Настройка уровней доступа администраторов</p>
      </div>

      {currentUser && currentUser.adminLevel < 9 && (
        <Alert>
          <Icon name="AlertCircle" className="h-4 w-4" />
          <AlertDescription>
            У вас недостаточно прав для управления администраторами. Требуется уровень 9 или выше.
          </AlertDescription>
        </Alert>
      )}
                ...
                <div>
                  ...
                  <form
                    onSubmit={(e) => {
                      ...
                      if (newPassword) {
                        handlePasswordReset(selectedUser.id, newPassword);
                      }
                    }}
                    className="space-y-3"
                  >
